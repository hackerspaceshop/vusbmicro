/*
 ...
 This code is heavily based on the CapsLocker code from macetech

 http://macetech.com/blog/?q=node/46

 We just modified the Makefile and the usbconfig.h

 garretts capslocker is based on christians thermostat code found on the obdev.at page
